...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        create_slideshow_with_audio(pictures_folder, videos_folder, output_video_path, audio_output_speedup_path, r"C:\Users\Happy yadav\Desktop\aura.ai\hackcbs-backend\ai_generated_images\Lydia.mp4", srt_file_path)
