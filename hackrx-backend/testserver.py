...
import os
import json
from testmain import *  # Make sure testmain contains all the required functions
from fastapi.middleware.cors import CORSMiddleware
from fastapi.responses import FileResponse
from moviepy.editor import AudioFileClip  # Import this if you are using moviepy for audio length
...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        create_slideshow_with_audio(pictures_folder, videos_folder, output_video_path, audio_output_speedup_path, 
                                      r"C:\Users\Happy yadav\Desktop\Technology\hack\hackrx-backend\ai_generated_images\Lydia.mp4", srt_file_path)
...
async def ask_question(question_request: QuestionRequest):
    try:
        ...
        headers = {
            ...
            'API-Subscription-Key': SARVAM_API_KEY  # Using the subscription key
        }
