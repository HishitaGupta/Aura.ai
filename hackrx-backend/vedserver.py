...
async def upload_pdf(file: UploadFile = File(...)):
    ...
    try:
        ...
        background_music_path = r"C:\Users\Happy yadav\Desktop\aura.ai\hackrx-backend\background.mp3"
        summary = summarize_text(text)
        
        generate_flow_from_summary(summary)
        ...
        create_slideshow_with_audio(pictures_folder, videos_folder, output_video_path, audio_output_speedup_path, r"C:\Users\Happy yadav\Desktop\aura.ai\hackrx-backend\ai_generated_images\Lydia.mp4", srt_file_path)
